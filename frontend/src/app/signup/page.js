...
export default function Signup() {
    ...
    return (
        <div style={{padding: 40, display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <input className="full border p-3 rounded mb-3" placeholder="First Name" onChange={e => setForm({...form, firstName: e.target.value})} />
            <input className="full border p-3 rounded mb-3" placeholder="Last Name" onChange={e => setForm({...form, lastName: e.target.value})} />
            <input className="full border p-3 rounded mb-3" placeholder="Email" onChange={e => setForm({...form, email: e.target.value})} />
            <input className="full border p-3 rounded mb-3" type="password" placeholder="Password" onChange={e => setForm({...form, password: e.target.value})} />
